...
@testset "Ripemd160" begin
    @test bytes2hex(Ripemd.ripemd160("asdf"))                                                           == "0ef2aed6346def670a8019e4ea42cf4c76018139"
    @test bytes2hex(Ripemd.ripemd160(""))                                                               == "9c1185a5c5e9fc54612808977ee8f548b2258d31"
    @test bytes2hex(Ripemd.ripemd160("a"))                                                              == "0bdc9d2d256b3ee9daae347be6f4dc835a467ffe"
    @test bytes2hex(Ripemd.ripemd160("abc"))                                                            == "8eb208f7e05d987a9b044a8e98c6b087f15a0bfc"
    @test bytes2hex(Ripemd.ripemd160("message digest"))                                                 == "5d0689ef49d2fae572b881b123a85ffa21595f36"
    @test bytes2hex(Ripemd.ripemd160("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789")) == "b0e20b6e3116640286ed3a87a5713079b21f5189"
    ...
    @test bytes2hex(Ripemd.ripemd160(Ripemd.codeunits("asdf")))                                                           == "0ef2aed6346def670a8019e4ea42cf4c76018139"
    @test bytes2hex(Ripemd.ripemd160(Ripemd.codeunits("")))                                                               == "9c1185a5c5e9fc54612808977ee8f548b2258d31"
    @test bytes2hex(Ripemd.ripemd160(Ripemd.codeunits("a")))                                                              == "0bdc9d2d256b3ee9daae347be6f4dc835a467ffe"
    @test bytes2hex(Ripemd.ripemd160(Ripemd.codeunits("abc")))                                                            == "8eb208f7e05d987a9b044a8e98c6b087f15a0bfc"
    @test bytes2hex(Ripemd.ripemd160(Ripemd.codeunits("message digest")))                                                 == "5d0689ef49d2fae572b881b123a85ffa21595f36"
    @test bytes2hex(Ripemd.ripemd160(Ripemd.codeunits("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"))) == "b0e20b6e3116640286ed3a87a5713079b21f5189"
